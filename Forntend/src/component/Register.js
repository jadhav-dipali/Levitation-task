...
export default function Register(){
    ...
    function sumbmitForm(e){
      ...
      setLoder(true)
      fetch("https://levitation-task-backend.onrender.com/user/register",{
           method:"POST",
           headers:{
    ...
    <h4 id="valid-user">Already Have An Account? <span id="color-change" onClick={()=>navigate("/")}>Login</span></h4>
    </div>
    </>
}